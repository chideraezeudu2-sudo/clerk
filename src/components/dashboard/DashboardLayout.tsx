...
export const DashboardLayout: React.FC<DashboardLayoutProps> = ({
  ...
  return (
    <div className="min-h-screen bg-[#fafaf9] text-[#0a2414] flex font-sans antialiased">
      {/* Sidebar */}
      <Sidebar
      ...
      <div className="flex-1 flex flex-col min-w-0 lg:pl-64">
        ...
        <header className="lg:hidden flex items-center justify-between px-6 py-3 bg-[#ffffff] border-b border-[#0a2414]/10 sticky top-0 z-30">
          <div className="flex items-center space-x-3">
            ...
            <span className="text-[20px] font-semibold tracking-[-0.03em] text-[#0a2414]">
              clerk
            </span>
          </div>
        ...
        <main
          className={`flex-1 w-full ${
            currentTab === 'assistant'
              ...
              : 'p-6 sm:p-6 lg:p-6 max-w-[1200px] mx-auto space-y-6'
          }`}
        >
          {currentTab === 'home' && (
            <HomeView
